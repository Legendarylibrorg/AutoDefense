 ...
 CASES = [
     ...
     },
     {
         ...
         "payload": {
             ...
             "model_output": "OK: -----BEGIN RSA PRIVATE KEY----- ... -----END RSA PRIVATE KEY-----",
         },
     },
     {
         "name": "tool_abuse",
